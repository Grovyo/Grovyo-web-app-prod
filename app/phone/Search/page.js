...
function page() {
  ...
  return (
    <div className="md:min-w-[390px] md:[360px] h-screen dark:bg-[#000] bg-[#fff] flex flex-col">
      <div className="flex flex-row justify-around mt-2 dark:bg-black bg-white items-center p-2 h-[6%] w-[100%]">
        <input
          onKeyPress={(e) => {
            if (e.key === "Enter") {
              handleSearch();
          ...
          value={text}
          className="ring-1 ring-[#e4e4e4]  bg-[#f7f7f7] dark:ring-[#000] dark:bg-[#3e3e3e] dark:text-[#fff] rounded-xl p-2 w-[85%] outline-none text-black"
          placeholder="Search"
