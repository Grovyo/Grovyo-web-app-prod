          ...
          <div className="flex w-[300px] pl-2">
            <div className="w-[50px] h-[100%] flex justify-center object-scale-down items-center ">
              <img
                alt="dp"
                src={dp}
                className="h-[45px] w-[45px] object-fill rounded-2xl ring-1 ring-white shadow-md "
              />
            </div>
            <div className="flex flex-col w-[79%] justify-center px-2 items-start">
              ...
              <div className="flex flex-row  justify-start z-0 w-[100%] items-center"></div>{" "}
              ...
              <div className="md:w-[50%] flex flex-col px-6 ">
                ...
                <div className="py-2 relative">
                  ...
                  <div className="text-[#5585FF] text-[13px] ">
                    "Maximize video reach with tags: Optimize discoverability
                    and target your audience effectively."
                  </div>
                </div>
                <div>
                  <div>Description</div>
